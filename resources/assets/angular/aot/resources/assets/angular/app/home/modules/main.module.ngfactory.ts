...
import * as import1 from '../../../../../../../app/home/modules/main.module';
...
import * as import18 from '../../../../../../../app/home/services/global.service';
import * as import19 from '@angular/core/src/di/injector';
import * as import20 from '../components/popover/popover.component.ngfactory';
import * as import21 from '../components/component1/1.component.ngfactory';
import * as import22 from '../components/component2/2.component.ngfactory';
...
class MainModuleInjector extends import0.NgModuleInjector<import1.MainModule> {
  ...
  __GlobalService_29:import18.GlobalService;
  constructor(parent:import19.Injector) {
    super(parent,[
      import20.PopoverComponentNgFactory,
      import21.Component1NgFactory,
      import22.Component2NgFactory
    ]
    ,[
      import21.Component1NgFactory,
      import22.Component2NgFactory
  ...
  get _LOCALE_ID_4():any {
    if ((this.__LOCALE_ID_4 == null)) { (this.__LOCALE_ID_4 = import3._localeFactory(this.parent.get(import23.LOCALE_ID,(null as any)))); }
  ...
  get _APP_ID_12():any {
    if ((this.__APP_ID_12 == null)) { (this.__APP_ID_12 = import24._appIdRandomProviderFactory()); }
  ...
  get _RootRenderer_20():any {
    if ((this.__RootRenderer_20 == null)) { (this.__RootRenderer_20 = import28._createConditionalRootRenderer(this._DomRootRenderer_19,this.parent.get(import28.NgProbeToken,(null as any)),this.parent.get(import8.NgProbeToken,(null as any)))); }
  ...
  get _AnimationQueue_23():import15.AnimationQueue {
    if ((this.__AnimationQueue_23 == null)) { (this.__AnimationQueue_23 = new import15.AnimationQueue(this.parent.get(import27.NgZone))); }
  ...
  get _GlobalService_29():import18.GlobalService {
    if ((this.__GlobalService_29 == null)) { (this.__GlobalService_29 = new import18.GlobalService()); }
    return this.__GlobalService_29;
  }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import23.LOCALE_ID)) { return this._LOCALE_ID_4; }
    if ((token === import5.NgLocalization)) { return this._NgLocalization_5; }
    if ((token === import30.ErrorHandler)) { return this._ErrorHandler_6; }
    ...
    if ((token === import24.APP_ID)) { return this._APP_ID_12; }
    if ((token === import31.DOCUMENT)) { return this._DOCUMENT_13; }
    ...
    if ((token === import32.AnimationDriver)) { return this._AnimationDriver_18; }
    if ((token === import13.DomRootRenderer)) { return this._DomRootRenderer_19; }
    if ((token === import33.RootRenderer)) { return this._RootRenderer_20; }
    if ((token === import14.DomSanitizer)) { return this._DomSanitizer_21; }
    if ((token === import34.Sanitizer)) { return this._Sanitizer_22; }
    ...
    if ((token === import18.GlobalService)) { return this._GlobalService_29; }
